              ...
              >
                ...
                {/*<MenuItem onClick={handleContactUs}>Contact Us</MenuItem>*/}
					...
					<Typography onClick={handleHome}>
						...
						<span className={classes.ankit}> Dr.Viraag</span>
					</Typography>
					}
					{(sessionStorage.getItem("userType") === "Patient") &&
					...
					{((itIsMobile === false) && (window.sessionStorage.getItem("userType") !== "Patient")) &&
						<div>
              <Button color="inherit" className={classes.commonButton} onClick={handleAppointment}>Appointment</Button>
              <Button color="inherit" className={classes.commonButton} onClick={handlePatient}>Patient</Button>
              <Button color="inherit" className={classes.commonButton} onClick={handleSummary}>Summary</Button>
              <Button color="inherit" className={classes.commonButton} onClick={handleInventory}>Inventory</Button>
              <Button color="inherit" className={classes.commonButton} onClick={handlePanelDoctor}>PanelDoctor</Button>
            </div>
					}
					{(false) &&
					<div align="right">
