...
export default function WorkingHours() {
  ...
  const handleAccordionChange = (panel) => (event, isExpanded) => {
	...
	let dayoftheweek = isMobile() ? SHORTWEEKSTR[currentIndex] + "." : WEEKSTR[currentIndex];
	return (
	<Box className={gClasses.boxStyle} borderColor="black" borderRadius={7} border={1} >
	...
	<Grid item xs={6} sm={3} md={3} lg={3} >
		{(sessionStorage.getItem("userType") === "Doctor") &&
			<VsButton name="Set default" onClick={() => {setDefaultSlots("MORNING", startNum, endNum)}} />
		}
	</Grid>
	<Grid item xs={6} sm={3} md={3} lg={3} >
	{(sessionStorage.getItem("userType") === "Doctor") &&
	...
	{workingArray.slice(startNum, endNum).map( (m, index) =>	{
		...
		return (
			<Grid key={"gr"+HOURSTR[hour]+":"+MINUTESTR[minute]} item xs={4} sm={2} md={1} lg={1} >	
			<Box className={gClasses.boxStyle} borderColor="black" borderRadius={7} border={1} >
				{(sessionStorage.getItem("userType") === "Doctor") &&
					<FormControlLabel 
					control={
	...
	<Grid item xs={6} sm={3} md={3} lg={3} >
		{(sessionStorage.getItem("userType") === "Doctor") &&
			<VsButton name="Set default" onClick={() => {setDefaultSlots("AFTERNOON", startNum, endNum)}} />
		}
	</Grid>
	<Grid item xs={6} sm={3} md={3} lg={3} >
	{(sessionStorage.getItem("userType") === "Doctor") &&
	...
	<Grid item xs={6} sm={3} md={3} lg={3} >
		{(sessionStorage.getItem("userType") === "Doctor") &&
			<VsButton name="Set default" onClick={() => {setDefaultSlots("EVENING", startNum, endNum)}} />
		}
	</Grid>
	<Grid item xs={6} sm={3} md={3} lg={3} >
	{(sessionStorage.getItem("userType") === "Doctor") &&
	...
	<Grid className={gClasses.noPadding} key="DOCTYPE" container alignItems="center" >
		<Grid key="DOCTYPETITLE" item xs={12} sm={12} md={12} lg={12} >
			<div align="center">
			<Typography className={classes.slotTitle} >{"Working Slots"}</Typography>
			</div>
		</Grid>		
		...
		{[0,1,2,3,4,5,6].map( (index) => {
			...
			return (
				<Grid key={"DOC"+index} item xs={3} sm={3} md={1} lg={1} >
